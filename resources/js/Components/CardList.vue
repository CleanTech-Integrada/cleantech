...
<template>
    <div class="card w-2/6 bg-base-100 shadow-accent overflow-y-hidden" style="max-height: 500px">
        <div class="card-body">
            <div v-for="item in list" class="rounded-xl flex justify-between items-center">
                <div>
